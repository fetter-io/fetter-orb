    ...
    return (
      <main className="min-h-screen font-[family-name:var(--font-geist-sans)] text-white bg-gradient-to-b from-slate-950 to-slate-900">
        <section className="flex flex-col items-center justify-center text-center py-32 px-4">
          ...
          <p className="text-lg text-zinc-400 mb-6">Python Supply-Chain Transparency</p>

          {status !== "authenticated" && (
            <button
              onClick={() => signIn("github")}
              className="px-4 py-2 bg-slate-600 text-zinc-300 rounded hover:bg-slate-500 hover:text-white cursor-pointer transition-colors duration-150"
            >
              Sign in with GitHub
            </button>
          )}
