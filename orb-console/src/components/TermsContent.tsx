export default function TermsContent() {
  return (
    <div className="prose-sm prose-invert bg-slate-950 max-h-140 rounded-lg overflow-y-auto p-4">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Fetter Orb, accessible from{" "}
            <a
              href="fetter.io"
      ...
      <p>
        ...
        efforts to provide at least 30 days&rsquo; notice prior to any new terms
      ...
      <ul>
        <li>By email: contact@fetter.io</li>
      </ul>
    </div>
  );
}
